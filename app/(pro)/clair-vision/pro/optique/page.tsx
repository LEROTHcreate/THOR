      ...
      {empty && (
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-8 py-16 text-center">
          ...
          <div className="flex justify-center gap-2">
            ...
            <Link href="/clair-vision/pro/agenda" className="inline-flex items-center gap-2 h-9 px-4 rounded-[10px] text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
              Ouvrir l'agenda
            </Link>
          </div>
        </div>
      ...
      {!empty && (
        <div className="grid gap-6 lg:grid-cols-[1fr_320px] items-start">
          ...
          <aside className="space-y-6 min-w-0">
            ...
            {/* Actions rapides */}
            <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-2">
...
function QuickLink({ href, label }: { href: string; label: string }) {
  return (
    <Link
      href={href}
      className="flex items-center justify-between gap-2 px-3 py-2.5 rounded-lg text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
    >
      <span>{label}</span>
