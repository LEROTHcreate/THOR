            ...
            <div className="pl-4 pr-24 pb-4 pt-3 flex-shrink-0" style={{ borderTop: "1px solid var(--glass-sep)" }}>
              ...
              <div className="flex items-end gap-2">
                ...
                <textarea
                  ...
                  rows={1}
                  className="flex-1 resize-none rounded-xl px-3.5 py-2.5 text-sm text-slate-800 placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-blue-300"
          ...
          <div style={{ background: "var(--glass-card-bg)", padding: 24 }}>
            <div className="mb-3">
              <input
                ...
                className="w-full rounded-xl px-3.5 py-2.5 text-sm text-slate-800 placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-blue-300"
                style={glassSubtle}
              />
            </div>
